	...
	<div class="p-5 mb-4 bg-light rounded-3 text-center"
		...
		<div class="row">
			...
			<ul class="nav nav-tabs" id="myTab">
			    ...
			    <li class="nav-item"><a aria-current="page" href="#sje" class="nav-link  active" data-bs-toggle="tab">数理情報演習(3年)</a></li>
			    <li class="nav-item"><a href="#juniors" class="nav-link" data-bs-toggle="tab">セミナーI(3年)</a></li>
			    <li class="nav-item"><a href="#seniors" class="nav-link" data-bs-toggle="tab">特別研究(4年)</a></li>			
		...
		<div class="tab-content">
			...
			<div class="row" >
				...
				<dl>
					...
					<a href="https://www.math.ryukoku.ac.jp/">数理・情報科学課程</a>)</dd>
				    <dt>部屋</dt>
		    ...
		    <div class="tab-pane fade show active" id="sje">
			<div class="row">
			    
			    <div class="col-12 order-md-2">
				<h3 class="page-header">数理情報演習(2023)</h3>
				<h4>Pythonと限らないプログラミングでWebを作ろう(予定)</h4>
				<p>Webブラウザやアプリを開くと, その向こうにはWebが広がっています. その Webは誰かがプログラムしています.
				    このテーマでWebの作り方に触れてみて</p>

				<a href="/course/juniors_2022/juniors_2022_hig.pdf">テーマ選択</a>(2022年度)				
				<ul>
				    ...
				    <li>フロントエンド, Webグラフィクス -- JavaScript, p5.js
					<ul>
					    <li>Webページ上に時間とともに変化する数学的・幾何学的図形を描きます. 亀のWeb版?</li>
					</ul>
				    </li>
				    <li>サーバサイド, サーバクライアントモデル, HTTP, Webアプリケーション -- Flask, Python
					<ul>
					    <li>Twitter や YouTube もWebアプリ. ユーザの入力を受け取り, ユーザにページとして出力する, Twitterの卵を作ります.
					    </li>
					</ul>
					...
					<ul>
					    <li>LINEやTwitterのチャットボットはWebと同じ技術で作られてます. 自動的に応答する bot を作ります.
					    </li>
					</ul>
			...
			<div class="row">
			    <div class="col-12">
				<h3 class="page-header">セミナーI・特別研究(3年)</h3>
			    </div>
			</div>

			<div class="col-12">
			    <a href="/course/juniors_2021/handout.pdf">配属案内</a>(2021)</h4>
			</div>
		    ...
		    <div class="tab-pane fade" id="seniors">
			<div class="row">
			    <div class="col-12">
			    ...
			    <div class="col-12">
				<a href="/course/seniors_2022/handout_seniors_2022_hig.pdf">配属案内</a>(2022)</h4>
				</div>
				<div class="col-12">
				    <h4>卒業論文(2022)</h4>
				    <ul>
				    <li> 学習しやすいグループワークのグループを作るWebアプリケーションの作成と評価</li>
				    <li> Linked Open Dataを用いた多肢選択式問題自動作成システムの開発</li>
				    ...
				    <li> manabaの課題を取得・定期通知するLINE Botの開発</li>
				    </ul>
				</div>
				...
				<div class="col-12">
					...
					<li>				Moodle上で動作する自動採点コンセプトマップQuestion Type</li>
